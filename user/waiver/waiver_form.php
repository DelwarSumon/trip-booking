					...
					<form action="<?php echo $n_lt_plUrl."?page=swaiver&conid=".$_GET['conid']; ?>" method="post" enctype="multipart/form-data" id="payment-form">
						...
						<div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12 p2 ">
							...
							<div class="form-group col-md-4">
								...
								<label for="" class="col-form-label float-left">Relation<sup>*</sup></label>
							...
							<div class="form-group col-md-12">
								...
								<input type="text"  class="form-control col-md-4 mr-2 mb-2" name="Top_3_Places_Traveled"  value="<?php echo $contact->Top_3_Places_Traveled; ?>" >
								<input type="text"  class="form-control col-md-3 mr-2 mb-2" name="Top_3_Places_Traveled_2"  value="<?php echo $contact->Top_3_Places_Traveled_2; ?>" >
								<input type="text"  class="form-control col-md-4 float-right mb-2" name="Top_3_Places_Traveled_3"  value="<?php echo $contact->Top_3_Places_Traveled_3; ?>" >
							...
							<div class="form-group col-md-12">
								...
								<div class="clr"></div>
								<input type="text"  class="form-control col-md-4 mr-2 mb-2" name="Top_5_Bucket_List_Countries"  value="<?php echo $contact->Top_5_Bucket_List_Countries; ?>" >
								<input type="text"  class="form-control col-md-3 mr-2 mb-2" name="Top_3_Bucket_List_Countries_2"  value="<?php echo $contact->Top_3_Bucket_List_Countries_2; ?>" >
								<input type="text"  class="form-control col-md-4 float-right mb-2" name="Top_3_Bucket_List_Countries_3"  value="<?php echo $contact->Top_3_Bucket_List_Countries_3; ?>" >
